...
export default function ModelCenter() {
  ...
  const models = [
    ...
    },
    {
      ...
      title: '支具有效性预测模型',
      description: '智能分析患者脊柱状况和支具参数，预测支具治疗的有效性，为支具选择和调整提供科学依据。',
    ...
    },
    {
      id: 'smart-annotation',
      title: '智能标注测量模型',
      description: '自动识别和标注X线影像中的关键解剖结构，精确测量各项脊柱参数，提高诊断效率和准确性。',
      icon: 'ri-ruler-line',
      status: '运行中',
      accuracy: '96.5%',
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <p className="text-gray-900 font-medium">智能标注测量模型已更新</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <p className="text-gray-900 font-medium">术前预测模型训练完成</p>
