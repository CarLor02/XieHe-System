...
export default function Home() {
  const statsData = [
    { title: '累计患者', value: 1247, change: 8.2, icon: 'ri-user-line', color: 'blue' as const },
    { title: '待处理影像', value: 23, change: -12.5, icon: 'ri-image-line', color: 'orange' as const },
    { title: '累计影像', value: 5648, change: 15.3, icon: 'ri-gallery-line', color: 'green' as const },
    { title: '今日诊断', value: 89, change: 22.1, icon: 'ri-stethoscope-line', color: 'purple' as const },
  ];
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">欢迎回来，今天有 {statsData[1].value} 个影像等待您的诊断</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">今日概况</h3>
