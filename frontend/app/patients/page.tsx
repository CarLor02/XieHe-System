          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6 sm:p-5">
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
              ...
              >
                更多选项
                {hasAdvancedFilters && (
                  <span className="ml-1.5 bg-blue-500 text-white text-xs rounded-full px-1.5">!</span>
                )}
              </button>
            </div>
            ...
            {showAdvancedFilters && (
              <div className="mt-4 pt-4 border-t border-gray-100 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute bottom-0 right-0 pr-3 flex items-center pointer-events-none" style={{height: '38px'}}>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="true">有影像</option>
                    <option value="false">无影像</option>
                  </select>
                </div>
              ...
              <div className="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                  <p className="text-sm text-gray-700">
                    ...
                    条， 共 <span className="font-medium">{totalPatients}</span>{' '}
                    条记录
                  </p>
