...
import {
  ...
  VertebraAnnotation,
  CfhAnnotation,
} from '@/app/imaging/viewer/shared/types';
import { AnnotationBindings, PointRef } from '@/app/imaging/viewer/features/bindings/domain/annotation-binding';
...
import {
  ...
  getInheritedPoints,
} from '@/app/imaging/viewer/features/measurements/domain/annotation-inheritance';
import {
  imageToScreen as utilImageToScreen,
  screenToImage as utilScreenToImage,
} from '@/app/imaging/viewer/features/annotation-canvas/domain/transform/coordinate-transform';
import { INTERACTION_CONSTANTS } from '@/app/imaging/viewer/shared/constants';
import { TransformContext } from '@/app/imaging/viewer/shared/types';
...
import { isDirectlyEditableAnnotation } from '@/app/imaging/viewer/features/measurements/domain/annotation-editability';
import {
  resolveMeasurementKeypointIds,
  resolveMeasurementPointDragTarget,
} from '@/app/imaging/viewer/features/keypoints/domain/measurement-keypoint-selection';
