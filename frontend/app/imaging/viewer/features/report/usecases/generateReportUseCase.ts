import {MeasurementData, ImageData} from "@/app/imaging/viewer/shared/types";
import { generateMeasurementReport } from '@/services/imageServices';
import { getAnnotationDisplayName, getAnnotationTypeId } from '@/app/imaging/viewer/features/measurements/catalog/shared/annotation-config';
