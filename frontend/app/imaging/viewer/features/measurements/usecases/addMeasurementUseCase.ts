import {ImageSize, MeasurementData, Point, Tool} from "@/app/imaging/viewer/shared/types";
import {
    calculateMeasurementValue as calcMeasurementValue
} from "@/app/imaging/viewer/features/measurements/domain/annotation-calculation";
...
} from "@/app/imaging/viewer/features/measurements/domain/annotation-uniqueness";
import {S1_BINDING_POINT_MAP} from "@/app/imaging/viewer/features/bindings/domain/annotation-binding";
