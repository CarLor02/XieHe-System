...
import { createEmptyBindings } from '@/app/imaging/viewer/image-viewer/features/bindings';
import { useAnnotationEngine } from '@/app/imaging/viewer/image-viewer/features/bindings';
import { useCanvasInteraction } from '@/app/imaging/viewer/image-viewer/features/annotation-canvas';
import { getToolsForExamType as getTools } from '@/app/imaging/viewer/image-viewer/features/measurements/catalog/exam-tool-catalog';
import {
...
} from '@/app/imaging/viewer/image-viewer/features/measurements';
import {
  canUseKeypointTools,
  useImageListFetcher,
  useImageStudy,
...
} from '@/app/imaging/viewer/image-viewer/features/study';
import { useReportActions } from '@/app/imaging/viewer/image-viewer/features/report';
import {
  isAnteriorExamType,
