import {ImageSize, MeasurementData, Point, Tool} from "@/app/imaging/viewer/image-viewer/shared/types";
import {
    calculateMeasurementValue as calcMeasurementValue
} from "@/app/imaging/viewer/image-viewer/features/measurements/domain/annotation-calculation";
import {getDescriptionForType as getDesc} from "@/app/imaging/viewer/image-viewer/features/measurements/domain/annotation-metadata";
...
} from "@/app/imaging/viewer/image-viewer/features/measurements/domain/annotation-uniqueness";
import {S1_BINDING_POINT_MAP} from "@/app/imaging/viewer/image-viewer/features/bindings/domain/annotation-binding";
