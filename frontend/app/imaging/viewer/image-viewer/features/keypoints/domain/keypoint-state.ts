...
} from '@/app/imaging/viewer/image-viewer/features/measurements/catalog/ap/keypoints';
import {
...
import { CfhAnnotation, Point, VertebraAnnotation } from '@/app/imaging/viewer/image-viewer/shared/types';

export type KeypointSource = ApKeypointSource;
