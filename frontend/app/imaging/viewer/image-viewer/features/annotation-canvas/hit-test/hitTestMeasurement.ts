import {
  ...
  isPolygonClicked,
  isRectangleClicked,
} from '@/app/imaging/viewer/image-viewer/features/annotation-canvas/domain/hit-test/shape-hit-test';
import { isAuxiliaryShape } from '@/app/imaging/viewer/image-viewer/features/annotation-canvas/domain/tools/tool-state';
import { getAnnotationTypeId } from '@/app/imaging/viewer/image-viewer/features/measurements/catalog/shared/annotation-config';
import { isEditableAuxiliaryAnnotationType } from '@/app/imaging/viewer/image-viewer/features/measurements/domain/annotation-metadata';
import { calculateQuadrilateralCenter } from '@/app/imaging/viewer/image-viewer/shared/geometry';
import { MeasurementData, Point, TransformContext } from '@/app/imaging/viewer/image-viewer/shared/types';
