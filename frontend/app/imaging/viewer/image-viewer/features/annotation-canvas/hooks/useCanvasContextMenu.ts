...
import { MeasurementData } from '@/app/imaging/viewer/image-viewer/shared/types';
import { isAuxiliaryTool } from '@/app/imaging/viewer/image-viewer/features/annotation-canvas/domain/tools/tool-state';
