...
import { hasUniqueAnnotationForTool } from '@/app/imaging/viewer/image-viewer/features/measurements/domain/annotation-uniqueness';
import { getAnnotationTypeId } from '@/app/imaging/viewer/image-viewer/features/measurements/catalog/shared/annotation-config';
import { Point, Tool } from '@/app/imaging/viewer/image-viewer/shared/types';
