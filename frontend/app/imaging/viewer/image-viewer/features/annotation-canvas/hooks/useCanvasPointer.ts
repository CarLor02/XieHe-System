...
import { calculateDistance } from '@/app/imaging/viewer/image-viewer/shared/geometry';
import { MeasurementData, Point } from '@/app/imaging/viewer/image-viewer/shared/types';
import { hitTestMeasurement } from '../hit-test/hitTestMeasurement';
import { hitTestWorkingPoint } from '../hit-test/hitTestPoint';
import {
  getMeasurementSelectionBoxInScreen,
  isPointInSelectionBox,
} from '../hit-test/selectionBox';
