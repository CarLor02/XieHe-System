...
import { isAuxiliaryShape as checkIsAuxiliaryShape } from '@/app/imaging/viewer/image-viewer/features/annotation-canvas/domain/tools/tool-state';
import { imageToScreen } from '@/app/imaging/viewer/image-viewer/features/annotation-canvas/domain/transform/coordinate-transform';
import { TEXT_LABEL_CONSTANTS, getAdaptiveFontSize } from '@/app/imaging/viewer/image-viewer/shared/constants';
import { estimateTextHeight, estimateTextWidth } from '@/app/imaging/viewer/image-viewer/shared/labels';
