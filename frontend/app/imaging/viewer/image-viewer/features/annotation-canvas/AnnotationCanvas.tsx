...
import { AnnotationBindings, PointRef } from '@/app/imaging/viewer/image-viewer/features/bindings/domain/annotation-binding';
import { CalculationContext } from '@/app/imaging/viewer/image-viewer/features/measurements/catalog/shared/annotation-config';
import { calculateMeasurementValue as calcMeasurementValue } from '@/app/imaging/viewer/image-viewer/features/measurements/domain/annotation-calculation';
import {
  POINT_INHERITANCE_RULES,
  SHARED_ANATOMICAL_POINT_GROUPS,
  getInheritedPoints,
} from '@/app/imaging/viewer/image-viewer/features/measurements/domain/annotation-inheritance';
import {
  imageToScreen as utilImageToScreen,
  screenToImage as utilScreenToImage,
} from '@/app/imaging/viewer/image-viewer/features/annotation-canvas/domain/transform/coordinate-transform';
import { INTERACTION_CONSTANTS } from '@/app/imaging/viewer/image-viewer/shared/constants';
import { TransformContext } from '@/app/imaging/viewer/image-viewer/shared/types';
import { useCanvasViewport } from './hooks/useCanvasViewport';
import { useCanvasSelection } from './hooks/useCanvasSelection';
import { useCanvasContextMenu } from './hooks/useCanvasContextMenu';
import { useStandardDistanceInteraction } from './hooks/useStandardDistanceInteraction';
import { useCanvasDrag } from './hooks/useCanvasDrag';
import { useCanvasDrawingTool } from './hooks/useCanvasDrawingTool';
import { useCanvasPointer } from './hooks/useCanvasPointer';
import { useVertebradDrag } from './hooks/useVertebradDrag';
import { useCanvasDrawing } from './hooks/useCanvasDrawing';
import { useCanvasOverlayState } from './hooks/useCanvasOverlayState';
import { useCanvasDerivedState } from './hooks/useCanvasDerivedState';
...
import MeasurementResultsPanel from './panels/MeasurementResultsPanel';
import CanvasControlsPanel from './panels/CanvasControlsPanel';
import CanvasHintPanel from './panels/CanvasHintPanel';
import renderMeasurement from './renderers/renderMeasurement';
import VertebraeLayer from './layers/VertebraeLayer';
import {
...
import { isDirectlyEditableAnnotation } from '@/app/imaging/viewer/image-viewer/features/measurements/domain/annotation-editability';
import {
  resolveMeasurementKeypointIds,
  resolveMeasurementPointDragTarget,
} from '@/app/imaging/viewer/image-viewer/features/keypoints/domain/measurement-keypoint-selection';
