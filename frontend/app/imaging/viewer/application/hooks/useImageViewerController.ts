...
import { createEmptyBindings } from '@/app/imaging/viewer/features/bindings';
import { useAnnotationEngine } from '@/app/imaging/viewer/features/bindings';
import { useCanvasInteraction } from '@/app/imaging/viewer/features/annotation-canvas';
import { getToolsForExamType as getTools } from '@/app/imaging/viewer/features/measurements/catalog/exam-tool-catalog';
import {
...
} from '@/app/imaging/viewer/features/measurements';
import {
  canUseKeypointTools,
  useImageListFetcher,
  useImageStudy,
...
} from '@/app/imaging/viewer/features/study';
import { useReportActions } from '@/app/imaging/viewer/features/report';
import {
  isAnteriorExamType,
