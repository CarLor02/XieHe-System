      ...
      current?.measurementId === measurementId && current.field === field
        ...
        : {
            ...
            anchor: {
              left: Math.max(
                4,
                Math.min(rect.left, viewportWidth - minWidth - 4)
              ),
              top: rect.bottom + 4,
              minWidth,
            },
    ...
    >
      ...
      {editingCobbEndpoint && editingCobbEndpointMeasurement && (
        <div
          role="listbox"
          aria-label={`选择${
            editingCobbEndpoint.field === 'upperVertebra' ? '上端椎' : '下端椎'
          }`}
        ...
        >
          {cobbEndpointOptions.map(option => {
            const isOppositeEndpointOption =
              ...
              normalizeEndpointValue(option) ===
                editingCobbOppositeEndpointValue;
