...
export default function BasicModePanel({
  ...
  return (
    <div className="mb-4">
      <h4 className="text-sm font-medium text-gray-300 mb-2 leading-none">
        <span>基础模式</span>
      </h4>
        ...
        {modes.map(mode => {
          ...
          return (
            <button
              ...
              className={`rounded-lg flex-1 min-w-[78px] h-12 transition-all relative flex items-center justify-center ${
                isSelected
