    ...
    <DropdownMenu.Root open={open} onOpenChange={onOpenChange} modal={modal}>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          className={`z-50 rounded-lg border border-gray-200 bg-white shadow-lg outline-none data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 ${contentClassName}`}
        >
          {children}
        </DropdownMenu.Content>
      </DropdownMenu.Portal>
