...
from app.contexts.imaging.infrastructure.persistence import ImageFile  # noqa: E402
from app.contexts.patients.infrastructure.persistence.models import (  # noqa: E402
    Patient,
)
