...
async def get_report_overview(
    ...
    try:
        ...
        mock_data = ReportStatistics(
            ...
            reports_by_status={"已完成": 1089, "待审核": 98, "已拒绝": 60},
        )
...
async def get_patient_analytics(
    ...
    try:
        mock_data = PatientAnalytics(
            ...
            patients_by_gender={"男": 1234, "女": 1222},
...
async def get_analytics_dashboard(
    ...
    try:
        ...
        charts = await get_time_series_data(
            time_range, ["reports", "completion_rate", "review_time"]
        )
