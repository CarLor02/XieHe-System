...
from lat.application.measurement_service import health_status, load_measurement_models, measure_image
from lat.interfaces.http.schemas import AnnotationsResponse, ObjectImageRequest
...
app = FastAPI(
    title="LAT Spine Analysis API",
    description="Lateral X-ray AI measurement service",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def measure_object(request: ObjectImageRequest):
    try:
        ...
        return measure_image(image, request.image_id or "lateral_spine")
